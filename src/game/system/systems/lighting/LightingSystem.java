...
//			}ids.add(ID.Tree);
	...
	private LinkedList<Point> createRays(int light_x, int light_y, int light_half_width, LinkedList<GameObject> objects, Graphics g) {
		...
		for(GameObject obj : objects) {
			if(((Bounds)obj).getBounds().inside(light_x, light_y)) {
				break;
			}
			...
			Point center = new Point(((Bounds)obj).getBounds().x+(((Bounds)obj).getBounds().width/2), ((Bounds)obj).getBounds().y+(((Bounds)obj).getBounds().height/2));
			if(!checkInBounds(center.x, center.y, origin.x, origin.y, light_half_width*2, light_half_width*2)) {
				continue;
			}
			Point top_left = new Point(((Bounds)obj).getBounds().x, ((Bounds)obj).getBounds().y);
			Point top_right = new Point(((Bounds)obj).getBounds().x+((Bounds)obj).getBounds().width, ((Bounds)obj).getBounds().y);
			Point bottom_right = new Point(((Bounds)obj).getBounds().x+((Bounds)obj).getBounds().width, ((Bounds)obj).getBounds().y+((Bounds)obj).getBounds().height);
			Point bottom_left = new Point(((Bounds)obj).getBounds().x, ((Bounds)obj).getBounds().y+((Bounds)obj).getBounds().height);
